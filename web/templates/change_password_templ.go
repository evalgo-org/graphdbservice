	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			if user.MustChangePassword {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, "<div class=\"alert alert-warning\" style=\"background: #fff3cd; color: #856404; border: 1px solid #ffeaa7; margin-bottom: 1.5rem;\">⚠ You must change your password before continuing.</div>")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			}
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 3, "<form id=\"change-password-form\" onsubmit=\"changePassword(event)\"><div class=\"form-group\"><label for=\"current-password\">Current Password</label> <input type=\"password\" id=\"current-password\" name=\"current_password\" required autocomplete=\"current-password\"></div><div class=\"form-group\"><label for=\"new-password\">New Password</label> <input type=\"password\" id=\"new-password\" name=\"new_password\" required minlength=\"8\" autocomplete=\"new-password\"> <small style=\"color: var(--gray-700); display: block; margin-top: 0.5rem;\">Minimum 8 characters, must include uppercase, lowercase, number, and special character</small></div><div class=\"form-group\"><label for=\"confirm-password\">Confirm New Password</label> <input type=\"password\" id=\"confirm-password\" name=\"confirm_password\" required minlength=\"8\" autocomplete=\"new-password\"></div><div id=\"password-error\" style=\"margin-top: 1rem; padding: 1rem; background: #fee2e2; color: #991b1b; border-radius: 0.375rem; display: none;\"></div><div id=\"password-success\" style=\"margin-top: 1rem; padding: 1rem; background: #d1fae5; color: #065f46; border-radius: 0.375rem; display: none;\"></div><div style=\"margin-top: 1.5rem; display: flex; gap: 1rem;\"><button type=\"submit\">Change Password</button> ")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			if !user.MustChangePassword {
